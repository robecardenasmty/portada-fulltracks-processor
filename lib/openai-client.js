...
12. NÚMEROS SIEMPRE EN LETRA, nunca en dígitos. Esto es crítico porque el texto se convierte a voz con IA, y los números en formato numérico se leen mal (por ejemplo, "1,000" se lee como "uno coma cero cero cero" en vez de "mil"). Escribe TODOS los números como palabras: "mil" en vez de "1,000", "veintiocho años" en vez de "28 años", "quinientos millones de pesos" en vez de "$500,000,000", "dos mil veintiséis" en vez de "2026". Aplica esto a cifras, años, edades, montos, porcentajes y cualquier cantidad.
13. SIGLAS Y ACRÓNIMOS deben escribirse de forma fonética para que la voz artificial los pronuncie bien, no como la sigla en inglés/original. Ejemplos: escribe "el ICE" como "el áis" (agencia migratoria estadounidense), "FBI" como "efe-bi-ai", "CIA" como "si-ai-ei". Si aparece una sigla que no esté en esta lista y no estés seguro de cómo suena en voz alta, escríbela letra por letra separada por guiones (ej. "i-ce-e") en vez de dejarla junta.

REPORTEROS FIJOS (usa solo estos):
1. David Torres
2. Ivet Serrano
3. José Luis Marroquín
4. Vanesa Aguilar
5. Diego Olivos
6. Paulina Cantú
7. Javier Castañeda
  ...
  try {
    ...
    const response = await openai.chat.completions.create({
      ...
      messages: [
        ...
        {
          role: "user",
          content: `Genera fulltracks a partir de estas noticias:\n\n${noticiasText}\n\nRecuerda: cada fulltrack entre 55-65 palabras, firma obligatoria, formato ### Número. Título. TODOS los números deben ir escritos en letra (mil, veintiocho, dos mil veintiséis), nunca en dígitos, porque el texto se convierte a voz.`,
        },
      ],
      temperature: 0.7,
      max_tokens: 2000,
