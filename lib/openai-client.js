...
6. Si falta información, redacta de forma general usando expresiones como "de acuerdo con la publicación", "según la portada" o "la nota señala".
7. No uses lenguaje exagerado, amarillista o de opinión.
8. Mantén estructura de noticiero: entrada informativa, desarrollo breve, impacto o contexto, y firma final.
9. Cada nota debe salir como un bloque separado.
10. No repitas el mismo reportero en notas consecutivas, salvo que ya se hayan usado todos los nombres disponibles.
...
ESTILO DE REDACCIÓN:
Debe sonar como voz off de reportero de noticiero. Usa frases claras.
